...
clear
echo -e " "
echo -e "\033[31m 若在使用中发现问题，请及时联系 微信:小萝卜 进行反馈！ \033[0m"
echo -e " "
echo -e "\033[32m 赞助商ADS: \033[0m"
echo -e "\033[32m 美国洛杉矶CN2GIA服务器-特价促销中-KURUN CLOUD机房直销 \033[0m"
echo -e "\033[32m 官网:https://idc.xlb.lol/ \033[0m"
echo -e " "
echo -e "\033[33m 如果你不喜欢脚本有ads，可以联系小萝卜删除！ \033[0m"
